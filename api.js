...
async function loadProducts() {
    try {
       ...
       <div class="shop-item__image">
        ...
        <img src="/img/shopping-cart.svg" alt="shopping-cart" class="cart-img"/></button>
        <button class="view-product"><img src="/img/eye.svg" alt="eye"/></button>
        <button class="favourite-product"><img src="/img/heart.svg" alt="favourite"/></button>
        </div>
        </div>
